...
class PhysicsEngine:
    ...
    def __init__(self, physics_controller: PhysicsInterface, robot: "MyRobot"):
        ...
        # fmt: on
        self._l_lead_motor = robot._drivetrain._left_leader.sim_state
        self._l_follow_motor = robot._drivetrain._left_follower.sim_state
        self._r_lead_motor = robot._drivetrain._right_leader.sim_state
        self._r_follow_motor = robot._drivetrain._right_follower.sim_state
    ...
    def update_sim(self, now: float, tm_diff: float) -> None:
        ...
        self._l_lead_motor.setBusVoltage(wpilib.RobotController.getBatteryVoltage())
        self._l_follow_motor.setBusVoltage(wpilib.RobotController.getBatteryVoltage())
        self._r_lead_motor.setBusVoltage(wpilib.RobotController.getBatteryVoltage())
        self._r_follow_motor.setBusVoltage(wpilib.RobotController.getBatteryVoltage())

        # Apply the motor inputs to the simulation
        self._drivesim.setInputs(self._l_lead_motor.getMotorOutputLeadVoltage(), self._r_lead_motor.getMotorOutputLeadVoltage())
        ...
        self._l_lead_motor.set_raw_rotor_position( self.feet_to_encoder_ticks(self._drivesim.getLeftPositionFeet()) )
        self._l_lead_motor.set_rotor_velocity( self.velocity_feet_to_talon_ticks(self._drivesim.getLeftVelocityFps()) )
        self._r_lead_motor.set_raw_rotor_position( self.feet_to_encoder_ticks(self._drivesim.getRightPositionFeet()) )
        self._r_lead_motor.set_rotor_velocity( self.velocity_feet_to_talon_ticks(self._drivesim.getRightVelocityFps()) )
        self._l_follow_motor.set_raw_rotor_position( self.feet_to_encoder_ticks(self._drivesim.getLeftPositionFeet()) )
        self._l_follow_motor.set_rotor_velocity( self.velocity_feet_to_talon_ticks(self._drivesim.getLeftVelocityFps()) )
        self._r_follow_motor.set_raw_rotor_position( self.feet_to_encoder_ticks(self._drivesim.getRightPositionFeet()) )
        self._r_follow_motor.set_rotor_velocity( self.velocity_feet_to_talon_ticks(self._drivesim.getRightVelocityFps()) )
